...
public class C05_Actions extends TestBase {
    ...
    public void test01(){
        ...
        //6- Elemental Selenium linkine tiklayalim
            /* sayfaya gitmeden önce ilk sayfanın handle degerini almak gerekiyor*/
        String ilkSayfaWDH=driver.getWindowHandle();
        driver.findElement(By.linkText("Elemental Selenium")).click();
        Set<String> tumWDHleriSeti=driver.getWindowHandles();
        String ikinciSayfaWDH="";
        for (String each :tumWDHleriSeti
        ) {
          if (!each.equals(ilkSayfaWDH)) {
              ikinciSayfaWDH=each;
          }
        }
        driver.switchTo().window(ikinciSayfaWDH);
        //7- Acilan sayfada h1 taginda “Elemental Selenium” yazdigini test edelim
